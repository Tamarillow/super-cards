...
Using an "End Turn" button to activate next turn.
...
nextplayer <- eventReactive(input$turnend,{
  ...
  if (nextplayerid>length(tamallow$playernames)){
    nextplayerid <- 1
  }
  
  newplayer <- tamallow$playernames[nextplayerid]
