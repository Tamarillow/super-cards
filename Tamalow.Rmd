...
```{r echo = FALSE}
jack <<- "PNG/green_back.png"

#jack <- eventReactive(input$JocheckGroup, {if(input$JocheckGroup==2){"PNG/green_back.png"}else {"PNG/red_back.png"}})

#observeEvent(input$JocheckGroup, { if(input$JocheckGroup==2){jack <<-"PNG/green_back.png"}else {jack <- "PNG/red_back.png"}})
...
renderImage({
  return(list(
        width = 150,
        src = paste0("PNG/",tamallow$players$Jo[3], ".png"),
        contentType = "image/png",
        alt = "Card"
      ))
 }, deleteFile = FALSE )), 
...
renderImage({
  return(list(
        width = 150,
        src = paste0("PNG/",tamallow$players$Jo[4], ".png"),
        contentType = "image/png",
        alt = "Card"
      ))
 }, deleteFile = FALSE )) )
